...
This is a cosmos-sdk module taken from [osmosis](https://github.com/osmosis-labs/osmosis) `v14.0.0-rc1` (commit `26e2fad8e7b3eb7c33965360b31a593b392d7d75`)
...
> You can only use this feature from chains with IBC module starting from [`v3.4.0`](https://github.com/cosmos/ibc-go/releases/tag/v3.4.0) version
