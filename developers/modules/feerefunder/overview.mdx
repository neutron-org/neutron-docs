...
1. **Fee Collection**: Smart contracts can lock fees for acknowledgement and timeout processing by calling the LockFees message with the IBC packet information
