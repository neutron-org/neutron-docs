...
message MsgSubmitTx {
  ...
  string memo = 5;
  uint64 timeout = 6;
  neutron.feerefunder.Fee fee = 7; // Optional
}
```
...
2. **Transaction Submission:** The module validates the request, delegates to the ICA controller keeper for packet creation
