...
| | Pros | Cons |
|---|---|---|
| **AMMs** | 1. Liveness<br/>2. Computational efficiency<br/>3. Composability | 1. Overly complicated<br/>2. Unsustainable emissions schemes<br/>3. Capital inefficient / high slippage |
| **Orderbooks** | 1. Capital efficient<br/>2. Tried and tested<br/>3. Familiar | 1. Computationally inefficient<br/>2. Non-composable |
...
Concentrated liquidity and orderbooks differ slightly in how liquidity providers accrue value. On concentrated liquidity AMMs, liquidity providers accrue value through a [fee](/developers/modules/dex/concepts/fees) that they choose when placing the liquidity. The fee is a predetermined premium that traders pay when using the liquidity to swap between two assets.
