...
This message can only be executed through governance proposals. To update the DEX module parameters, submit a governance proposal that includes this message:

```json
{
  "title": "Update DEX Parameters",
  "description": "Update max pool spread and minimum tick spacing for DEX module",
  "messages": [
    {
