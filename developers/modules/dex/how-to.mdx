...
```bash
neutrond query dex pool-reserves-all \
  untrn:ibc/27394FB092D2ECCD56123C74F36E4C1F926001CEADA9CA97EA622B25F41E5EB2 \
  untrn
```
...
```bash
neutrond query dex limit-order-tranche-user neutron1... <tranche-key>
```
...
```bash
neutrond query dex tick-liquidity-all \
  untrn:ibc/27394FB092D2ECCD56123C74F36E4C1F926001CEADA9CA97EA622B25F41E5EB2 \
  untrn
```

#### Check Limit Order Tranches

```bash
neutrond query dex limit-order-tranche-all \
  untrn:ibc/27394FB092D2ECCD56123C74F36E4C1F926001CEADA9CA97EA622B25F41E5EB2 \
  untrn
```

#### View Inactive (Filled) Orders

```bash
neutrond query dex inactive-limit-order-tranche \
  untrn:ibc/27394FB092D2ECCD56123C74F36E4C1F926001CEADA9CA97EA622B25F41E5EB2 \
  untrn 100 <tranche-key>
```
...
neutrond query dex pool-reserves-all pair-id token-in
