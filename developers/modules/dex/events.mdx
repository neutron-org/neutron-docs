...
The Dex module emits various events during transaction processing. These events provide detailed information about deposits, withdrawals, limit orders, and swaps.
...
sdk.Event{
    ...
    Attributes: []sdk.Attribute{
        ...
        {Key: "amount_out", Value: "950000ibc/27394FB092D2ECCD56123C74F36E4C1F926001CEADA9CA97EA622B25F41E5EB2"},
        {Key: "exit_limit_price", Value: "0.95"},
        {Key: "effective_price", Value: "0.95"},
    },
}
```
...
Emitted when trading fees are collected by liquidity providers.

| Attribute Key | Description |
| --- | --- |
| `pool_id` | The ID of the pool where fees were collected |
| `fee_recipient` | Address that received the fees |
| `token0_fees` | Amount of token0 fees collected |
| `token1_fees` | Amount of token1 fees collected |

```go
sdk.Event{
    Type: "dex_fee_collection",
    Attributes: []sdk.Attribute{
        {Key: "pool_id", Value: "1"},
        {Key: "fee_recipient", Value: "neutron1..."},
        {Key: "token0_fees", Value: "1000"},
        {Key: "token1_fees", Value: "1000"},
    },
}
```
...
| Attribute Key | Description |
| --- | --- |
| `pool_id` | The unique identifier for the new pool |
