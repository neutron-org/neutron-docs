...
neutrond query txs --events 'message.action=/cosmos.gov.v1beta1.MsgSubmitProposal' \
  --events 'proposal.proposal_type=ParameterChange'
```
...
1. **Essential Operations**: Only bypass critical governance and staking operations
