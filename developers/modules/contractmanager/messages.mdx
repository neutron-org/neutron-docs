...
This message can only be executed through governance proposals. To update the Contract Manager module parameters, submit a governance proposal that includes this message:

```json
{
  "title": "Update Contract Manager Parameters",
  "description": "Update the sudo call gas limit for contract manager operations",
  "messages": [
    {
