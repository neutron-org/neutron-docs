...
<Warning>
**No Transaction Commands**: The Contract Manager module does not provide CLI transaction commands for individual users. All operations are handled automatically by the module or through CosmWasm contract messages.
</Warning>
