...
// Union type for all possible sudo messages
#[cw_serde]
pub enum HarpoonSudoMsg {
    AfterValidatorCreated(AfterValidatorCreatedMsg),
    AfterValidatorBonded(AfterValidatorBondedMsg),
    AfterValidatorRemoved(AfterValidatorRemovedMsg),
    AfterValidatorBeginUnbonding(AfterValidatorBeginUnbondingMsg),
    BeforeValidatorModified(BeforeValidatorModifiedMsg),
    BeforeValidatorSlashed(BeforeValidatorSlashedMsg),
    BeforeDelegationCreated(BeforeDelegationCreatedMsg),
    BeforeDelegationSharesModified(BeforeDelegationSharesModifiedMsg),
    BeforeDelegationRemoved(BeforeDelegationRemovedMsg),
    AfterDelegationModified(AfterDelegationModifiedMsg),
    AfterUnbondingInitiated(AfterUnbondingInitiatedMsg),
}
```
