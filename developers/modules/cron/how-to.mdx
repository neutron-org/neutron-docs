...
<Note>
Neutron uses a [modular governance system](/concepts/modular-governance) with specialized subDAOs that handle different aspects of network management. The Cron SubDAO is specifically designed to manage scheduling proposals, allowing for more efficient governance of routine scheduling tasks while maintaining community oversight.
</Note>
