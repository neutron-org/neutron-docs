...
| --- | --- | --- |
| `authority` | string | The address of the governance account (must be the governance authority) |
| `params` | Params | The new parameters to set |

### Governance Usage

This message can only be executed through governance proposals. To update the Revenue module parameters, submit a governance proposal that includes this message:

```json
{
  "title": "Update Revenue Module Parameters",
  "description": "Update validator performance requirements and compensation settings",
  "messages": [
    {
