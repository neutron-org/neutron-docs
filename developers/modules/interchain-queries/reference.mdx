...
<Note>
The CLI commands below are available for testing, debugging, and simple use cases. For production applications, most developers use CosmWasm smart contracts which provide better result handling, automatic processing, and integration with application logic.
</Note>
