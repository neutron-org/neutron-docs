...
At this point, for both contracts and non-contracts IBC fees are disabled

### 5. Automatic Fee Operations

Right now, fees are disabled. That means you can submit no fees. Even if you specify fees in MsgTransfer, they won't be charged.
