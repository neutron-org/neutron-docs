...
1. **Fee Collection**: Transaction fees are collected in the fee collector account during block execution
   
2. **Fee Processing**: At the end of each block, the module processes all fees in the fee collector account:
