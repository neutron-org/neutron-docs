...
graph TD
    ...
    classDef depositFlow fill:#e1f5fe,stroke:#01579b,stroke-width:2px
    classDef withdrawalFlow fill:#f3e5f5,stroke:#4a148c,stroke-width:2px
...
#### Vault Capacity
Most vaults have a maximum deposit capacity. When the TVL is equal or greater to the vault capacity it is not possible to deposit into the vault. This is done to promote optimal capital efficiency and ensure APYs remain high. 
