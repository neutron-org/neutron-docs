...
<Note> Supervaults <a href="https://app.neutron.org/supervaults" target="_blank" className="text-primary hover:underline font-bold underline decoration-primary/50">are now live</a>! Start earning optimized yields with automated liquidity management. Ready to get started? Check out the <a href="#how-to-deposit-into-supervaults" className="text-primary hover:underline underline decoration-primary/50">how-to deposit section</a> below for step-by-step instructions.</Note>
