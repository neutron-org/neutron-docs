...
> **Note:** the minimal amount of fee to be specified for the messages above is defined via parameter [`min_fee`](https://github.com/neutron-org/neutron/blob/v4.2.4/proto/neutron/feerefunder/params.proto#L13) controlled by governance proposal.
