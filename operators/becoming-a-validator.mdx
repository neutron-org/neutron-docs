...
This guide will help you join Neutron's validator set after you have [set up your node](/operators/running-a-node) and [configured your oracle service](/validators/oracle-setup).
