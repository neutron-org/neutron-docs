---
title: "v6.0.3"
description: "Instructions for upgrading to Neutron v6.0.3"
...
This document describes the steps for validators and full node operators to upgrade successfully to the Neutron v6.0.3 release. For more details on the release, please see the release notes.
...
<Steps>
  ...
  <Step title="Start with Cosmovisor">
    Start the node:
...
<AccordionGroup>
  <Accordion title="Q: My node restarted in the middle of upgrade process (OOM killed, hardware issues, etc), is it safe to just proceed with the upgrade?">
